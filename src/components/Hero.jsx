...
<div className="relative animate-slide-up" style={{animationDelay: '0.2s'}}>
  ...
  <div className="absolute -top-4 -right-4 bg-gradient-to-br from-gb-orange-400 to-gb-orange-500 text-white px-6 py-3 rounded-full shadow-2xl transform rotate-3 hover:rotate-0 transition-transform z-20">
    <div className="text-sm font-bold whitespace-nowrap">Live Demo</div>
  </div>

            {/* Main glass card */}
            <div className="relative bg-gradient-to-br from-white/40 to-white/20 backdrop-blur-xl rounded-3xl p-4 sm:p-6 lg:p-8 shadow-glass-lg border border-white/30">
              {/* Header */}
